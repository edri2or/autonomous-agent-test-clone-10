...
| R-07 | GitHub App Cloud Run receiver | Lifecycle validated | `tools/staging/test-r07-receiver-lifecycle.sh` covers happy path + timeout teardown + WEBHOOK_URL pre-flight; E2E manual |
