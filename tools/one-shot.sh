...
# Store the PAT as GH_ADMIN_TOKEN so bootstrap.yml can auto-update GitHub
...
try:
    gh('POST', f'/repos/{REPO}/actions/workflows/bootstrap.yml/dispatches',
       {'ref': 'main', 'inputs': {
           'dry_run':        'false',
...
print()
print("━" * 64)
print(f"  Triggered: https://github.com/{REPO}/actions/workflows/bootstrap.yml")
print()
